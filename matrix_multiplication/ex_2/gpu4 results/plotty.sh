...
plot "lib4_3.out" using 1:2 title "CPU" with lp, "gpu2.out" using 1:2 title "GPU2" with lp, \
...
"gpu4_5.out" using 1:2 title "GPU4_5" with lp, "gpu4_6.out" using 1:2 title "GPU4_6" with lp
